...
class PS4ImageDeswizzle:
    def __init__(self,im,format):
        ...
        self.coord_L = copy.deepcopy(format.ps4_unswizzle_list)
        if self.coord_L == None:
            raise Exception(f'Error: unimplemented PS4 Swizzle for the format {format.name}')
...
class PS4ImageSwizzle:
    def __init__(self,im,format):
        self.coord_L = copy.deepcopy(format.ps4_swizzle_list)
        if self.coord_L == None:
            raise Exception(f'Error: unimplemented PS4 Swizzle for the format {format.name}')
        self.format = format
